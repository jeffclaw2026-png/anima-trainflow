...
PORTABLE_PYTHON = Path("/home/jeffrey/comfyui/ComfyUI/.venv-py312/bin/python")
...
DEFAULT_SETTINGS = {
    "trigger_word": "",
    "dataset_path": "",
    "dit_path": str(Path("/home/jeffrey/comfyui/ComfyUI/models/diffusion_models/anima/anima-base-v1.0.safetensors")),
    "qwen_path": str(Path("/home/jeffrey/comfyui/ComfyUI/models/text_encoders/qwen_3_06b_base.safetensors")),
    "vae_path": str(Path("/home/jeffrey/comfyui/ComfyUI/models/vae/qwen_image_vae.safetensors")),
    "network_rank": 32,
...
if __name__ == "__main__":
     ui.launch(server_name="0.0.0.0", server_port=8877, theme=gr.themes.Soft(), css=CSS)